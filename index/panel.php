...
function _($_) {
    ...
    if (0 === \strpos($_['type'] . '/', 'page/') && (
        ...
        \Hook::set('do.page.get', __NAMESPACE__ . "\\do__page__get", 11);
        \Hook::set('do.page.set', __NAMESPACE__ . "\\do__page__set", 11);
        \Hook::set('do.page/page.get', __NAMESPACE__ . "\\do__page__get", 11);
        \Hook::set('do.page/page.set', __NAMESPACE__ . "\\do__page__set", 11);
    }
...
function do__page__get($_) {
    return \x\panel__tag\do__page__set($_);
}
